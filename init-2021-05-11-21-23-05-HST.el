...
;; (setq my-org-roam-default-location  "~/kailani/teaching/CEE696S21-ENG-MATH/")
(setq my-org-roam-default-location  "/home/albertsk/kailani/projects/Emacs/org-roam/")

(setq org-roam-directory        my-org-roam-default-location)
(setq source-org-roam-directory org-roam-directory)
;;(setq org-roam-db-location      my-org-roam-default-location)
...
(use-package org-roam-server
  ...
  :load-path my-org-roam-default-location
  ;; "~/kailani/teaching/CEE696S21-ENG-MATH/"
  ;;org-roam-directory
  ;; :custom
  ;;
  ;; (setq org-roam-db-location my-org-roam-default-location)
...
(defun reset-my-org-roam-default-location ()
  "To reset org-roam-directory as an input directory, and remake org-roam-db."
  (interactive)
  (let (word)
    (setq word
